...
@WebServlet(value = "/recurrents")
public class RecurrentsServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try{
            ...
            recurrentsService.save(recurringPayments);

            req.setAttribute("success", "Pagamento recorrente registrado com sucesso!");
            List<RecurringPayments> recurrents = recurrentsService.getRecurrents(user.getId());
